...
function ArticlesSection() {
  return (
    <div className="py-10 bg-[#53565A] text-white flex flex-col items-center">
      <h2 className="text-4xl font-bold text-center mb-7">Новини и статии</h2>
        ...
        {articles.map((article) => (
          <div key={article.id}>
            ...
            <div className="p-4 text-left">
              ...
              <Link
                to={article.link}
                className="mt-3 inline-block bg-orange-500 text-white font-bold px-4 py-2 rounded-lg hover:bg-orange-700 transition duration-300">
                Прочети още
              </Link>
            </div>
          </div>
